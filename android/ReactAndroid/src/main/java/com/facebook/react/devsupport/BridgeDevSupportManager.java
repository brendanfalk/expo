...
public class BridgeDevSupportManager extends DevSupportManagerBase {
    ...
    public BridgeDevSupportManager(Context applicationContext, ReactInstanceDevHelper reactInstanceManagerHelper, @Nullable String packagerPathForJSBundleName, boolean enableOnCreate, @Nullable RedBoxHandler redBoxHandler, @Nullable DevBundleDownloadListener devBundleDownloadListener, int minNumShakes, @Nullable Map<String, RequestHandler> customPackagerCommandHandlers, @Nullable SurfaceDelegateFactory surfaceDelegateFactory) {
        super(applicationContext, reactInstanceManagerHelper, packagerPathForJSBundleName, enableOnCreate, redBoxHandler, devBundleDownloadListener, minNumShakes, customPackagerCommandHandlers, surfaceDelegateFactory);
        ...
        if (!getDevSettings().isDeviceDebugEnabled()) {
            ...
            addCustomDevOption(getDevSettings().isRemoteJSDebugEnabled() ? applicationContext.getString(com.facebook.react.R.string.reactandroid_catalyst_debug_stop) : applicationContext.getString(com.facebook.react.R.string.reactandroid_catalyst_debug), new DevOptionHandler() {
