...
import abi45_0_0.com.facebook.react.modules.core.ReactChoreographer;
import abi45_0_0.com.facebook.react.uimanager.GuardedFrameCallback;
import abi45_0_0.com.facebook.react.uimanager.IllegalViewOperationException;
import abi45_0_0.com.facebook.react.uimanager.ReactShadowNode;
...
import abi45_0_0.com.facebook.react.uimanager.UIManagerReanimatedHelper;
import abi45_0_0.com.facebook.react.uimanager.events.Event;
import abi45_0_0.com.facebook.react.uimanager.events.EventDispatcherListener;
import abi45_0_0.com.facebook.react.uimanager.events.RCTEventEmitter;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.layoutReanimation.AnimationsManager;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.AlwaysNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.BezierNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.BlockNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.CallFuncNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.ClockNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.ClockOpNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.ConcatNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.CondNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.DebugNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.EventNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.FunctionNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.JSCallNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.Node;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.NoopNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.OperatorNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.ParamNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.PropsNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.SetNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.StyleNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.TransformNode;
import abi45_0_0.host.exp.exponent.modules.api.reanimated.nodes.ValueNode;
...
public class NodesManager implements EventDispatcherListener {
  ...
  public String obtainProp(int viewTag, String propName) {
    ...
    if ("opacity".equals(propName)) {
      Float opacity = view.getAlpha();
      result = Float.toString(opacity);
    } else if ("zIndex".equals(propName)) {
