...
package abi46_0_0.host.exp.exponent.modules.api.viewshot;
...
import abi46_0_0.com.facebook.react.bridge.GuardedAsyncTask;
...
import abi46_0_0.host.exp.exponent.modules.api.viewshot.ViewShot.Formats;
import abi46_0_0.host.exp.exponent.modules.api.viewshot.ViewShot.Results;
...
public class RNViewShotModule extends ReactContextBaseJavaModule {
    ...
    private File createTempFile(@NonNull final Context context, @NonNull final String ext, String fileName) throws IOException {
        ...
        if (fileName != null) {
            return Files.createTempFile(cacheDir.toPath(), fileName, suffix).toFile();
        }
